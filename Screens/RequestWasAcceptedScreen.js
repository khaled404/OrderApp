...
const RequestWasAcceptedScreen = () => {
  const cartItems = [
    {
      typeImag: true,
        ...
        <View>
          <View style={minStyles.topHeaderContainer}>
            ...
            <View style={minStyles.orderNumberContainer}>
              ...
              <View>
                <Text style={minStyles.orderNumberTitle}>
                  تم قبول الطلب وجاري التجهيز مدة التجهيز 30 دقيقة{' '}
                </Text>
              </View>
            </View>
            <View
              ...
              />
              <Text style={minStyles.timer}>00:29:59</Text>
            </View>
          </View>
        </View>
        <View style={minStyles.boxTop}>
          <Text style={minStyles.boxTopTitle}>
            ريح ولا تشيل هم طلبك بيوصل بأسرع وقت
          </Text>
        </View>
        <View>
...
export default RequestWasAcceptedScreen;
